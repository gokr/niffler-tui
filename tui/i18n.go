...
var catalogEn = map[string]string{
	...
	"status.hint":                    "| /provider /model /connect /mcp /help | alt+enter: newline | ctrl+r: history | ctrl+e: tools | ctrl+t: think | ctrl+g: effort | esc: stop | ctrl+c: quit",
...
var catalogZh = map[string]string{
	...
	"status.hint":                    "| /provider /model /connect /mcp /help | alt+enter: 换行 | ctrl+r: 历史 | ctrl+e: 工具 | ctrl+t: 思考 | ctrl+g: 深度 | esc: 停止 | ctrl+c: 退出",
...
var catalogZhTW = map[string]string{
	...
	"status.hint":                    "| /provider /model /connect /mcp /help | alt+enter: 換行 | ctrl+r: 歷史 | ctrl+e: 工具 | ctrl+t: 思考 | ctrl+g: 深度 | esc: 停止 | ctrl+c: 結束",
