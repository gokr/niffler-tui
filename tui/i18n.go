...
var catalogEn = map[string]string{
	...
	"help.components":                "  /components [all|direct|discovered|undiscovered]  what this conversation can call",
...
var catalogZh = map[string]string{
	...
	"help.components":                "  /components [all|direct|discovered|undiscovered]  本会话可调用的工具",
...
var catalogZhTW = map[string]string{
	...
	"help.components":                "  /components [all|direct|discovered|undiscovered]  本對話可呼叫的工具",
