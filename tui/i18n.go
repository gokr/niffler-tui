...
var catalogEn = map[string]string{
	...
	"help.mcp":                       "  /mcp [add|edit|on|off|refresh]  manage external MCP servers (a: add, e: edit, d: remove)",
	...
	"mcp.unknownSubcommand":          "unknown /mcp subcommand: {0} (use add, edit, on, off, refresh)",
...
var catalogZh = map[string]string{
	...
	"help.mcp":                       "  /mcp [add|edit|on|off|refresh]  管理外部 MCP 服务器（a: 添加, e: 编辑, d: 删除）",
	...
	"mcp.unknownSubcommand":          "未知 /mcp 子命令：{0}（用 add、edit、on、off、refresh）",
...
var catalogZhTW = map[string]string{
	...
	"help.mcp":                       "  /mcp [add|edit|on|off|refresh]  管理外部 MCP 伺服器（a: 新增, e: 編輯, d: 刪除）",
